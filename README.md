...
- Download the repo into your IDE
    - Preferably using git because its cleaner
- Compile and run the code
    - This is for VS Code users (that's what I use)
    - You can try this on your IDE but I can't guarentee that it will work
    - Open the main.cpp or any other file in the src folder
